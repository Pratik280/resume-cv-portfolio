...
Backend Software Engineer with ~4 years of experience developing scalable microservices and event-driven systems using Java, Spring Boot, Apache Kafka, and Kubernetes. Experienced in designing secure APIs, multitenant architectures, and real-time transaction processing systems for financial platforms. Skilled in cloud infrastructure (AWS/Azure), CI/CD automation, and observability, with a strong focus on building reliable, high-performance distributed systems.
